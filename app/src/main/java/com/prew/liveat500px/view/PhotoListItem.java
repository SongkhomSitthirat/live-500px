package com.prew.liveat500px.view;
...
public class PhotoListItem extends BaseCustomViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int newHightMeasureSpec = MeasureSpec.makeMeasureSpec(height,MeasureSpec.EXACTLY);
    ...
    {
        Glide.with(getContext()).load(text).placeholder(R.drawable.loading).diskCacheStrategy(DiskCacheStrategy.ALL).into(ivImg);
    }
}
