...
public class PhotoSummaryFragment extends Fragment {
    ...
    private void initInstances(View rootView, Bundle savedInstanceState) {
        ...
        iv = (ImageView)rootView.findViewById(R.id.ivImg);
        tvName = (TextView)rootView.findViewById(R.id.tvName);
        tvDescription = (TextView)rootView.findViewById(R.id.tvDescription);

//        tvName.setText(dao.getUserId());
        tvDescription.setText(dao.getCaption());
        Glide.with(PhotoSummaryFragment.this).load(dao.getImageUrl()).diskCacheStrategy(DiskCacheStrategy.ALL).into(iv);
    }
